package com.client.biz.core;

import com.client.biz.ProviderServer;

/**
 * 项目常量
 */
public final class ProjectConstant {
	public static final String	BASE_PACKAGE				= ProviderServer.class.getPackage().getName();	// 项目基础包名称，根据自己公司的项目修改
